...
```
apt update -y; apt upgrade -y; apt install wget -y; bash <(wget -qO- https://github.com/lucianolima2905/gestor-ssh-sonyc-/raw/main/gestorssh/instpainel.sh)
```

# ♻ SINCRONIZAR NA VPS SSH!
```
apt install wget -y; bash <(wget -qO- https://github.com/lucianolima2905/gestor-ssh-sonyc-/raw/main/gestorssh/sincpainel.sh)
```

# 🛂 CHECKUSER PARA O APP CONECTA4G!
```
apt install wget -y; bash <(wget -qO- https://github.com/lucianolima2905/gestor-ssh-sonyc-/raw/main/gestorssh/instcheck.sh)
```
