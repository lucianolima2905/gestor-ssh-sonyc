...
```
apt install wget -y; bash <(wget -qO- https://github.com/lucianolima2905/gestor-ssh-sonyc/raw/main/install/ubuinst.sh)
```
</br>
...
```
apt install wget -y; bash <(wget -qO- https://github.com/lucianolima2905/gestor-ssh-sonyc/raw/main/install/sincpainel.sh)
```


# 𓊈𒆜 ATUALIZAÇÕES: (03/09/2023) 𒆜𓊉
```
1- Comando pweb
