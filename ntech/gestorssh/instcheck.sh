...
sleep 5
cd /bin || exit
wget https://github.com/lucianolima2905/gestor-ssh-sonyc/chuser > /dev/null 2>&1
wget https://github.com/lucianolima2905/gestor-ssh-sonyc/userscheck > /dev/null 2>&1
...
wget https://github.com/lucianolima2905/gestor-ssh-sonyc/checkuser.py > /dev/null 2>&1
